...
export const defaultFinancialCategories = [
  ...
  { name: "Servicos prestados", type: "income", keywords: ["servico", "site", "freela", "desenvolvimento"] },
  { name: "Recebimento de cliente", type: "income", keywords: ["cliente", "pix recebido", "recebimento"] },
  ...
  { name: "Hospedagem e servidores", type: "expense", keywords: ["servidor", "hospedagem", "vps", "aws", "vultr", "host"] },
  ...
  { name: "Transporte", type: "expense", keywords: ["uber", "99", "combustivel", "transporte"] },
  { name: "Alimentacao", type: "expense", keywords: ["restaurante", "lanche", "alimentacao", "mercado"] },
