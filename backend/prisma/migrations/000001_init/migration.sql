...
-- CreateEnum
CREATE TYPE "MemoryType" AS ENUM ('preference', 'fact', 'reminder', 'note', 'system');
...
-- CreateEnum
CREATE TYPE "TriggerType" AS ENUM ('manual', 'webhook', 'schedule', 'ai_command');

-- CreateEnum
CREATE TYPE "ActionType" AS ENUM ('n8n', 'whatsapp', 'home_assistant', 'internal');

-- CreateEnum
CREATE TYPE "AutomationLogStatus" AS ENUM ('success', 'error', 'pending');
